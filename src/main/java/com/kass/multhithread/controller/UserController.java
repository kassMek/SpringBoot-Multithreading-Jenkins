package com.kass.multhithread.controller;
import com.kass.multhithread.entity.User;
import com.kass.multhithread.service.UserService;
...
public class UserController {
   ...
   @Value("${my.greeting.list}")
   private List<Object> ENDPOINT_URL;
